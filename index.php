    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="col-xs-4 col-xs-offset-4">
                <img class="img-responsive bookImg" src="images/beachclub/guest-book.png">
            </div>
            ...
            <div class="col-xs-4 col-xs-offset-4">
                <img class="img-responsive bookImg" src="images/beachclub/contact.png">
            </div>
                ...
                <div class="col-md-4 col-md-offset-4 form">
                    <form class="form">
                      ...
                      <div class="form-group">
                        ...
                        <div>
                            <textarea rows="3" class="form-control" id="message" placeholder="Please Enter Message Here"></textarea>
                        </div>
                      </div>
                      <div>
